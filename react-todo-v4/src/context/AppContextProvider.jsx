 ...
 *
 * 이를 Context API를 활용하여
 * state와 공용으로 사용할 여러가지 함수를 Store에 보관하고
 * 필요한 곳에서만 useContext()를 사용하여 쉽게 getter할 수 있도록 도와주는 컴포넌트
 *
 * Context를 생성하기
...
function AppContextProvider({ children }) {
  ...
  const inputId = useRef(); // tag를 select 하는 용도로 쓸 수 있음
  ...
  // PProvider를 합성패턴으로 선언하여 필요한 곳에서 끌어올려 사용할 수 있도록 한다
