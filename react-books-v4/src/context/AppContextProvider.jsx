 ...
 * class 방식은 기존의 JS코드와 문법적인 면들이 많이 달라서
 * 함수방식을 도입한다 (16.x.x 버전에서)
 *
 * class 방식에서는 기본적으로 제공하는 약 10여가지 method가 있다
 * 이 method를 react에서는 lifeCycle method라고 불렀다
 * 프로젝트가 시작될 때, rendering이 시작될 때, rendering이 완료되었을 때, 현재화면이 닫힐 때
 * 등등의 상황에서 event를 일으키고
